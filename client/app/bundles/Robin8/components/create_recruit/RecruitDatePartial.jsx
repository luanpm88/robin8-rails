        ...
        <div className="content">
          <div className="date-range-form-area input-daterange">
            <div className="date-box satrt-date">
              <label>报名开始时间</label>
              <input {...recruit_start_time}  type="text" className="form-control" id="start-time-datepicker" name="startDate" readOnly required />
            </div>
            <div className="date-box end-date">
              <label>报名截止时间</label>
              <input {...recruit_end_time} type="text" className="form-control" id="deadline-datepicker" name="endDate" readOnly required />
            </div>
          </div>
        </div>
      </div>
