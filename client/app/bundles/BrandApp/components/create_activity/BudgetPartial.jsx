...
class BudgetPartial extends React.Component {
  render() {
          ...
          <div className="spinner-form-area">
            ...
            <div className="spinner-box">
              ...
              <div className="input-group bootstrap-touchspin">
                ...
                <input {...budget} type="text" defaultValue={0} className="spinner-input budget-input form-control" readOnly style={{display: 'block'}} />
