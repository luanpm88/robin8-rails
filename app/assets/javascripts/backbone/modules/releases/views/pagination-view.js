Robin.module('Releases', function(Releases, App, Backbone, Marionette, $, _){
  ...
  Releases.PaginationView = Marionette.ItemView.extend({
    template: 'modules/releases/templates/pagination-view',
    pageOffset: 3,
    tagName: 'nav',
    attributes: {
      align: 'center'
    ...
    modelChanged: function(model){
      Robin.Releases.controller.paginate(this.model.get('page'));
      this.render();
    }
  });
});
