class Transaction < ActiveRecord::Base
  ...
  validates_inclusion_of :subject, in: %w(campaign manual_recharge manual_withdraw withdraw check_in  invite_friend  complete_info favorable_comment lettory_activity)
