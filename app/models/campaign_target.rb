class CampaignTarget < ActiveRecord::Base
  ...
  validates_inclusion_of :target_type, :in => %w(age region gender influence_score professions sns_platforms remove_campaigns remove_kols add_kols specified_kols social_accounts)
