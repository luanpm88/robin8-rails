...
RSpec.describe "draft_pitches/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit draft_pitch form" do
    render

    assert_select "form[action=?][method=?]", draft_pitch_path(@draft_pitch), "post" do
