...
RSpec.describe PitchesController, type: :controller do
  ...
  #       post :create, {:pitch => invalid_attributes}, valid_session
  #       expect(assigns(:pitch)).to be_a_new(Pitch)
  #     end
  ...
  #       pitch = Pitch.create! valid_attributes
  #       put :update, {:id => pitch.to_param, :pitch => new_attributes}, valid_session
  #       pitch.reload
  ...
  #       pitch = Pitch.create! valid_attributes
  #       put :update, {:id => pitch.to_param, :pitch => invalid_attributes}, valid_session
  #       expect(assigns(:pitch)).to eq(pitch)
  #     end
