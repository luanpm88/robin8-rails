    ...
    class Campaigns < Grape::API
      resources :campaigns do
        ...
        put ':id/receive' do
          ...
          elsif !current_kol.is_big_v? && today_approved_invite_count >= 3
            return error_403!({error: 1, detail: '未申请成为KOL,每天只能接3个活动!' })
          elsif current_kol.is_big_v? && today_approved_invite_count >= 5
            return error_403!({error: 1, detail: '为了提高广告质量,每天限制接5个活动!' })
          else
