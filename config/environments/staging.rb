Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [/http:\/\/passport.robin8.net/, 'http://test.robin8.net']
  ...
  config.action_controller.asset_host = ENV['new_qa'] ? 'http://o7q8cw0n8.bkt.clouddn.com' : 'http://7xtngn.com2.z0.glb.qiniucdn.com'
