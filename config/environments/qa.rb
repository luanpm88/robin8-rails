Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [/https:\/\/passport.robin8.net/, 'https://test.robin8.net', 'https://qa.robin8.net']
  ...
  config.action_controller.asset_host = '//cdn-qa.robin8.net'
