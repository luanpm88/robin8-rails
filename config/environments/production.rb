Rails.application.configure do
  ...
  #config.action_controller.asset_host = 'http://7xqim6.com2.z0.glb.qiniucdn.com/'
  config.action_controller.asset_host = 'http://7xqim6.com2.z0.glb.qiniucdn.com/'
  ...
  config.action_cable.allowed_request_origins = %w(http://robin8.net)
  ...
  # config.action_controller.asset_host = 'https://static-robin8-com.akamaized.net/'
